...
export const CHUNKS: Chunk[] = [
  {
    ...
    tokenCount: 312,
    preview: "The API uses platform session cookies. Browser requests include the active session automatically...",
    embedText: "Authentication Overview: The API uses platform session cookies. Requests are validated by the central auth service and scoped to the current tenant...",
