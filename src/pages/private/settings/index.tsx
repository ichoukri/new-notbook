            ...
            <div className="flex-1 min-w-0">
              ...
              {activeTab === "vector-store" && (
                ...
                >
                  ...
                  <SettingRow
                    ...
                    description="Target index in the vector store"
                  >
                    <Input
              ...
              {activeTab === "permissions" && (
                ...
                >
                  ...
                  >
                    <Input
                      defaultValue="engineering, data-team"
                      className="w-72"
                    />
                  </SettingRow>
                  <SettingRow
    ...
    <div className="flex items-center justify-between gap-6 py-3.5">
      ...
      <div className="flex items-center gap-3 w-60 flex-shrink-0">
        <Slider
          ...
          className="flex-1"
        />
        <span className="text-sm font-semibold text-indigo-700 w-14 text-right tabular-nums">
          {value[0]}
        </span>
      </div>
    </div>
